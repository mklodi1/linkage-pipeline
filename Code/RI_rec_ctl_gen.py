...
> generates CTL file for RI recessive run

"""

import os

dir_path = r'/lab01/Projects/Mudassir_Projects/linkage/Pedigree/rec/RI_ASD'
count = 0
with open('/lab01/Projects/Mudassir_Projects/linkage/CTL/RI_ASD_rec.ctl', 'w') as f:
	...
	for file_path in os.listdir(dir_path):
			...
			if os.path.exists(cdr_file) == True:
				f.write('/lab01/Projects/Mudassir_Projects/linkage/Pedigree/rec/RI_ASD/' + file_path + '\t')
				cdr_file = '/nfs/xing_lab/brz_vcf/VAAST_JUN_3_2019/CDR/fam_%s.filtered.cdr' % (fam)
				f.write(cdr_file + '\t')
	f.write('\n')

...
> under dominant inheritance pattern, identifies samples and families containing each language impairment SNP candidate risk gene
...
reflist_f = results_path + "/SNP_Analysis/Results/pVAAST/LI_ASD/dom/LI_ASD_dom.reflist"
csv_f = results_path + "/SNP_Analysis/Results/pVAAST/LI_ASD/dom/LI_ASD_dom.csv"

...
> generates CTL file for LI recessive run

"""

import os

dir_path = r'/lab01/Projects/Mudassir_Projects/linkage/Pedigree/rec/LI_ASD'
count = 0
with open('/lab01/Projects/Mudassir_Projects/linkage/CTL/LI_ASD_rec.ctl', 'w') as f:
	...
	for file_path in os.listdir(dir_path):
			...
			if os.path.exists(cdr_file) == True and fam != '1036':
				f.write('/lab01/Projects/Mudassir_Projects/linkage/Pedigree/rec/LI_ASD/' + file_path + '\t')
				cdr_file = '/nfs/xing_lab/brz_vcf/VAAST_JUN_3_2019/CDR/fam_%s.filtered.cdr' % (fam)
				f.write(cdr_file + '\t')
	f.write('\n')
	...
	f.write('inheritance_model:      recessive               # dominant / recessive\n')
	f.write('\n')

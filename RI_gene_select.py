...
with open('/lab01/Projects/Mudassir_Projects/linkage/Variant_Analysis/Gene_Analysis/Results/RI_gene_table_non_benign_new.txt') as f:
	for line in f:
		if 'Gene' in line:
			continue
		else:
...
with open('/lab01/Projects/Mudassir_Projects/linkage/Variant_Analysis/Gene_Analysis/Results/RI_gene_summary.txt','w') as f2:	
...
with open('/lab01/Projects/Mudassir_Projects/linkage/Variant_Analysis/Gene_Analysis/Results/RI_gene_tiers.txt','w') as f1:

...
> generates pedigree files for Reading Impairment patients under recessive inheritance model
...
with open("/lab01/Projects/Mudassir_Projects/linkage/Data/cohort_summary_edited_2023-06-27.txt", "r") as f1:
	...
	for line1 in f1:
            ...
            if len(PED_columns) > 1 and 'Father' not in line1:
                ...
                filePath = '/lab01/Projects/Mudassir_Projects/linkage/Pedigree/rec/RI_ASD/fam_%s_RI_ASD_rec.ped' % (family)
                f2 = open(filePath, 'w')

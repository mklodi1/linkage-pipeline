...
> under recessive inheritance pattern, identifies samples and families containing each reading impairment SNP candidate risk gene
...
reflist_f = results_path + "/SNP_Analysis/Results/pVAAST/RI_ASD/rec/RI_ASD_rec.reflist"
csv_f = results_path + "/SNP_Analysis/Results/pVAAST/RI_ASD/rec/RI_ASD_rec.csv"
var_res = results_path + "/SNP_Analysis/Results/RI_ASD_rec_var.txt"
genes = results_path + "/SNP_Analysis/Results/RI_rec_genes_fam.txt"

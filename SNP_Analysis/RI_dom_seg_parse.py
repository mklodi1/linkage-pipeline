...
> under dominant inheritance pattern, identifies samples and families containing each reading impairment SNP candidate risk gene
...
reflist_f = results_path + "/SNP_Analysis/Results/pVAAST/RI_ASD/dom/RI_ASD_dom.reflist"
csv_f = results_path + "/SNP_Analysis/Results/pVAAST/RI_ASD/dom/RI_ASD_dom.csv"
